...
#define ADIS16209_ENDURANCE	0x00	//Diagnostics, flash write counter (16-bit binary)
#define ADIS16209_SUPPLY_OUT	0x02	//Output, power supply
#define ADIS16209_XACCL_OUT	0x04	//Output, x-axis acceleration
#define ADIS16209_YACCL_OUT	0x06	//Output, y-axis acceleration
#define ADIS16209_AUX_ADC		0x08	//Output, auxiliary ADC
#define ADIS16209_TEMP_OUT	0x0A	//Output, temperature
#define ADIS16209_XINCL_OUT	0x0C	//Output, ±90° x-axis inclination
#define ADIS16209_YINCL_OUT	0x0E	//Output, ±90° y-axis inclination
...
#define ADIS16209_ALM_CTRL	0x28	//Alarm, source control register
#define ADIS16209_AUX_DAC	0x30	//Auxiliary DAC data
#define ADIS16209_GPIO_CTRL	0x32	//Operation, digital I/O configuration and data
#define ADIS16209_MSC_CTRL	0x34	//Operation, data-ready and self-test control
#define ADIS16209_SMPL_PRD	0x36	//Operation, sample rate configuration
#define ADIS16209_AVG_CNT	0x38	//Operation, filter configuration
#define ADIS16209_SLP_CNT	0x3A	//Operation, sleep mode control
#define ADIS16209_STATUS	0x3C	//Diagnostics, system status register
#define ADIS16209_COMMAND	0x3E	//Operation, system command register


#define ADIS16209_SCLK	GPIO_Pin_10
#define ADIS16209_DIN	GPIO_Pin_12
#define ADIS16209_CS	GPIO_Pin_13

#define ADIS16209_DOUT	GPIO_Pin_5
#define ADIS16209_DOUT2	GPIO_Pin_4


#define ADIS16209_PORT	GPIOB
...
#define MPU6050_I2C_SCL_PinSource	   GPIO_PinSource10
#define MPU6050_I2C_SDA_PinSource	   GPIO_PinSource11
